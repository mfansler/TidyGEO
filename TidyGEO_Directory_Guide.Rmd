...
3. There's not really a great way to deal with invalid column names when the user renames a column to something like "#$%^&*()". Currently the app just keeps the names, until any formatting is performed on the column, then the name might change to something like "V1....."
