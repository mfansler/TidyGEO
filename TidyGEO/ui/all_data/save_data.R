tabPanel(title = icon("download"), value = "3",
         ...
         radioButtons("all_file_type", div("File type:", help_link("all", "files_help")), c("Comma-separated file" = "csv", "Tab-separated file" = "tsv", 
                                                                                "JSON" = "JSON", "Excel" = "xlsx", "Formatted for BRB Array Tools" = "txt")),
         p("BRB Array Tools", help_link("all", "brb_help_all")),
