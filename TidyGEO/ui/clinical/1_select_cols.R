tabPanel(title = FILTER_ICON, value = "1",
         ...
         help_modal_ui("clinical_filter_help", "help_docs/Filter_Data_Documentation.md", c("filter_presets_example.gif", "filter_by_name_example.gif"), c("Demo - Filter using Presets", "Demo - Filter by Name")),
