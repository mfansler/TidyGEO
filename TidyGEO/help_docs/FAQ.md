...
* __What should my data look like after I am finished?__
    + This depends entirely on the research question you are trying to answer. But usually for analysis, it is helpful to put the data in _tidy_ format, which, according to data scientist Hadley Wickham, means that:
...
#### (3-4) Splitting pairs and splitting columns
